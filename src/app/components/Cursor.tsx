...
const Cursor = () => {
  ...
  return (
    <div id="custom-cursor" className="hidden fixed top-0 left-0 size-[20px] rounded-full pointer-events-none z-[9999999] mix-blend-difference p-2 sm:flex justify-center items-center bg-white">
    </div>
  );
};
